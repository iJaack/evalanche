...
export enum EvalancheErrorCode {
  ...
  ENDPOINT_VERIFICATION_ERROR = 'ENDPOINT_VERIFICATION_ERROR',
  ...
  POLYMARKET_MARKET_CLOSED = 'POLYMARKET_MARKET_CLOSED',
  POLYMARKET_INSUFFICIENT_GAS = 'POLYMARKET_INSUFFICIENT_GAS',
}
